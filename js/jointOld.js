...
(function (root, factory) {
    ...
    // if require.js is included in your page, start to load with AMD(Asinchronous Module Definition)
    if (typeof define === 'function' && define.amd) {
        ...
        //module exports dovrà essere usato con require nel modulo che lo richiede e che implementa node.js
        ...
        //joint, g , V are namespaces to ease the access to joint internal namespaces
    ...
    var g = (function () {
        ...
        //prototipo con tutti i metodi implementati
        g.Ellipse.prototype = {
             ...
             */
            center: function () {
                //questo è una classe quindi ritorna gli attributi x e y dell'oggetto
        ...
        //prototype con tutti i metodi della classe line
        g.Line.prototype = {
            ...
            equals: function (l) {
                // !!l il primo "!" casta l a booleano, mentre il secondo ritorna il valore originae booleano
                // non so se togliendo entrambi i !! funzionerebbe comunque da testare
                return !!l &&
        ...
        */
        ...
        g.Point.prototype = {
            ...
            // direzione tra questo e punto dato, direzione rapresentata da una linea
            ...
            // Norma/Lunghezza del vettore corrispondente al punto
            magnitude: function () {
            ...
            // calcola la distanza vista come la somma del percorso a L da i due punti
            ...
            // Serve per riuscire a spostare gli oggeti in una griglia
            ...
            // This explain the strange indexof('@') considering point a string
            toString: function () {
            ...
            // Prodotto scalare tra due punti ritorna un numero
            //conosciuto anche come dotted product
            dot: function (p) {
        ...
        var Rect = g.Rect = function (x, y, w, h) {
            ...
            // Per la clone, quando esegui "return Rect(this)"
            if ((Object(x) === x)) {
                y = x.y;
                w = x.width;
                h = x.height;
        ...
        // conversione da ellisse a rettangolo passando come argomento un ellisse
        // @param {ellipse} Ellisse da cui ottendere il rettangolo
        ...
        g.Rect.prototype = {
            ...
            pointNearestToPoint: function (point) {
                ...
                if (this.containsPoint(point)) {
                    ...
                    switch (side) {
                        case 'right':
                            return Point(this.x + this.width, point.y);
                        case 'left':
                            return Point(this.x, point.y);
                        case 'bottom':
                            return Point(point.x, this.y + this.height);
                        case 'top':
                            return Point(point.x, this.y);
                    }
                }
        ...
        // "Curva" formata da sequenza di punti
    ...
    V = Vectorizer = (function () {
            ...
            for (var i = 0; i < lines.length; i++) {
                ...
                if (line) {
                    ...
                    if (opt.annotations) {
                        ...
                        var lineAnnotations = V.annotateString(lines[i], V.isArray(opt.annotations) ? opt.annotations : [opt.annotations], {
                            offset: -offset,
                            includeAnnotationIndices: opt.includeAnnotationIndices
                        });
        ...
        V.prototype.attr = function (name, value) {
            ...
            // nel caso in si voglia copiare un oggetto dentro un oggetto "vectorizer"
        ...
        V.createSvgDocument = function (content) {
            ...
            var xml = V.parseXML(svg, {
                async: false
            });
            return xml.documentElement;
        };

        // private attribute to create a unique id in method "uniqueId"
        V.idCounter = 0;
        ...
        // give a node always a unique id
    ...
    var joint = {
        ...
        util: {
            ...
            // Compact Unique RFC 4122 Universally Unique Identifier generator
            // Relies heavily on the randomness of Math.random() to keep the UUIds unique
            uuid: function () {
            ...
            // Convert a string into a format-like-this
            ...
            // Return an object with all attributes and methods as the event you wanted to normalize
                ...
                if (magnet) {
                    ...
                    if (!spot) {
                        bbox = V(magnet).getBBox({
                            target: linkView.paper.viewport
                        });
                    }
            ...
            // Get the BBox from the a string identifier of an element inside you document
    ...
    joint.dia.Graph = Backbone.Model.extend({
        ...
        // Add new attribute/s or method/s to an existing model
        ...
        // Remove all cells (first Links then the others elements) 
        clear: function (opt) {

            opt = joint.util.assign({}, opt, {
                clear: true
            });
        ...
        disconnectLinks: function (model, opt) {
            ...
            this.getConnectedLinks(model).forEach(function (link) {
                ...
                link.set(link.get('source').id === model.id ? 'source' : 'target', {
                    x: 0,
                    y: 0
                }, opt);
            });
        ...
        // Use for multi- selection, drag, etc...
        ...
        startBatch: function (name, data) {
            ...
            return this.trigger('batch:start', joint.util.assign({}, data, {
                batchName: name
            }));
        },
        ...
        stopBatch: function (name, data) {
            ...
            return this.trigger('batch:stop', joint.util.assign({}, data, {
                batchName: name
            }));
        },
    ...
    // To understand better this anonimous function
    ...
    joint.dia.Cell = Backbone.Model.extend({
        ...
        // Overwritten inside the subclasses
        translate: function (dx, dy, opt) {
        ...
        toBack: function (opt) {
            ...
            if (this.graph) {
                ...
                if (opt.deep) {
                    ...
                    cells.reverse().forEach(function (cell) {
                        cell.set('z', z--, opt);
                    });
                }
        ...
        clone: function (opt) {
            ...
            if (!opt.deep) {
                ...
                return joint.util.toArray(joint.dia.Graph.prototype.cloneCells.call(null, [this].concat(this.getEmbeddedCells({
                    deep: true
                }))));
            }
        },
        ...
        startBatch: function (name, opt) {
            if (this.graph) {
                this.graph.startBatch(name, joint.util.assign({}, opt, {
                    cell: this
                }));
            }
            return this;
        ...
        stopBatch: function (name, opt) {
            if (this.graph) {
                this.graph.stopBatch(name, joint.util.assign({}, opt, {
                    cell: this
                }));
            }
            return this;
            ...
            for (var i = 0, n = relativeItems.length; i < n; i++) {
                ...
                if (!refBBox) {
                    ...
                    refBBox = bboxCache[refNodeId] = (refNode) ?
                        V(refNode).getBBox({
                            target: (opt.rotatableNode || rootNode)
                        }) :
                        opt.rootBBox;
                }
    ...
    joint.dia.Element = joint.dia.Cell.extend({
        ...
        size: function (width, height, opt) {
            ...
            // WHY YOU DO THIS? ლ(ಠ_ಠლ) 
            // Setter
            // (size, opt) signature
            // size is passed as an Object{width: xxxx, height: xxxx} 
            if (joint.util.isObject(width)) {
                // height is passed as the opt parameter in this case so we save it in the right variable
                opt = height;
    ...
    joint.dia.ElementView = joint.dia.CellView.extend({
         ...
         */
        _initializePorts: function () {
            // to implement in not existing ports.js
        },
        ...
        prepareEmbedding: function (opt) {
            ...
            joint.util.invoke(connectedLinks, 'set', 'z', maxZ + 1, {
                ui: true
            });
            ...
            parentId && graph.getCell(parentId).unembed(model, {
                ui: true
            });
        },
        ...
        processEmbedding: function (opt) {
            ...
            if (paperOptions.frontParentOnly) {
                // pick the element with the highest `z` index, the last one
        ...
        finalizeEmbedding: function (opt) {
            ...
            joint.util.invoke(paper.model.getConnectedLinks(model, {
                deep: true
            }), 'reparent', {
                ui: true
            });
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        renderVertexMarkers: function () {
            ...
            joint.util.toArray(this.model.get('vertices')).forEach(function (vertex, idx) {
                ...
                $markerVertices.append(V(markupTemplate(joint.util.assign({
                    idx: idx
                }, vertex))).node);
            });
        ...
        updateLabelPositions: function () {
            ...
            for (var idx = 0, n = labels.length; idx < n; idx++) {
                ...
                var offset = isPositionObject ? position.offset : {
                    x: 0,
                    y: 0
                };
        ...
        getConnectionPoint: function (end, selectorOrPoint, referenceSelectorOrPoint) {
            ...
            joint.util.isEmpty(selectorOrPoint) && (selectorOrPoint = {
                x: 0,
                y: 0
            });
            joint.util.isEmpty(referenceSelectorOrPoint) && (referenceSelectorOrPoint = {
                x: 0,
                y: 0
            });
        ...
        startArrowheadMove: function (end, opt) {
            ...
            this._initialEnd = joint.util.assign({}, this.model.get(end)) || {
                x: 0,
                y: 0
            };
            ...
            if (this._action === 'label-move') {
                ...
                if (paperOptions.snapLinks) {
                    ...
                    if (magnetUnderPointer) {
                        ...
                        model.set(arrowhead, arrowheadValue, {
                            ui: true
                        });
                    }
                }
    ...
    joint.dia.Paper = joint.mvc.View.extend({
        ...
        defineGradient: function (gradient) {
            ...
            if (!this.isDefined(gradientId)) {
                ...
                var gradientAttrs = joint.util.assign({
                    id: gradientId
                }, gradient.attrs);
    ...
    joint.routers.orthogonal = (function (util) {
        ...
        function vertexElement(from, to, toBBox, brng) {
            ...
            var freePts = pts.filter(function (pt) {
                return !toBBox.containsPoint(pt);
            });
            var freeBrngPts = freePts.filter(function (pt) {
            ...
            if (freeBrngPts.length > 0) {
                ...
                p = freeBrngPts.filter(function (pt) {
    ...
    joint.layout.DirectedGraph = {
        ...
        layout: function (graphOrCells, opt) {
            ...
            if (opt.resizeClusters) {
                ...
                joint.util.invoke(clusters, 'fitEmbeds', {
    ...
    // return the namespace to use in your scope
    return joint;
